...
{
    public class ReporteCumplimientoEnviosLecheData
    {
        ...
        public ReporteCumplimientoEnviosLecheData() { }
        public ReporteCumplimientoEnviosLecheData(int id_cliente, string cliente, string destino, string establo,
